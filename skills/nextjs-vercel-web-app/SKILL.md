---
skill: nextjs-vercel-web-app

description: Create a website using nextjs and deploy it to Vercel using the Vercel CLI. This skill records how to deploy, some common troubleshooting tips, and things learned for maintining or updating the website
---
## Prerequisites
